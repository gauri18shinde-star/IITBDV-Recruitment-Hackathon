...
class ObstacleAvoidanceNode(Node):
    def __init__(self):
        ...
        self.safe_distance = 1 #___(1)___  # Fill blank 1: Minimum safe distance from obstacles
        ...
        if front < self.safe_distance or self.is_turning:
            ...
            if not self.is_turning:
                ...
                if left_side > right_side:
                    ...
                    self.twist.angular.z = 0.5 #___(2)___  # Fill blank 2: Angular velocity for left turn
                else:
                    self.get_logger().info("Obstacle in front. Turning right.")
                    self.twist.angular.z = 0.5 # ___(3)___ # Fill blank 3: Angular velocity for right turn
            ...
            self.twist.linear.x = 0.5# ___(4)___  # Fill blank 4: Linear velocity for backward motion
            self.twist.angular.z = 0.0
        
        else:
            # Path is clear, move forward
            self.is_turning = False
            self.twist.linear.x = 0.5 #___(5)___  # Fill blank 5: Linear velocity for forward motion
            self.twist.angular.z = 0.0
...
def main(args=None):
    ...
    node =ObstacleAvoidanceNode()# ___(6)___  # Fill blank 6: Instance of the ObstacleAvoidanceNode class
    try:
        rclpy.spin(node) 
