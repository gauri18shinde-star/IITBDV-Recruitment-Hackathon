...
def generate_launch_description():
    ...
    pkg_robot_sim = FindPackageShare('robot_sim')
    default_rviz_config_path = PathJoinSubstitution([pkg_robot_sim, 'rviz', 'urdf.rviz'])
    ...
    model_arg = DeclareLaunchArgument(
        'model', default_value='racecar_bot.urdf',
